...
class RestaurateurDashboardScreen extends ConsumerStatefulWidget {
  const RestaurateurDashboardScreen({super.key});

  @override
  ConsumerState<RestaurateurDashboardScreen> createState() => _RestaurateurDashboardScreenState();
}

class _RestaurateurDashboardScreenState extends ConsumerState<RestaurateurDashboardScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Tableau de Bord Restaurateur'),
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              if (_selectedIndex == 0) {
                context.push('/restaurateur/restaurants/add');
              } else {
                context.push('/restaurateur/menus/add');
              }
            },
          ...
          NavigationRail(
            ...
            destinations: const [
              NavigationRailDestination(
                ...
                label: Text('Mes Restaurants'),
              ),
              NavigationRailDestination(
                icon: Icon(Icons.menu_book),
                selectedIcon: Icon(Icons.menu_book),
                label: Text('Mes Menus'),
              ),
            ],
          ),
                ...
                trailing: Row(
                  ...
                  children: [
                    IconButton(
                      ...
                      onPressed: () => context.push('/restaurateur/restaurants/${restaurant.id}/edit'),
                      tooltip: 'Modifier',
                    ),
                    IconButton(
              ...
              child: ListTile(
                ...
                trailing: Row(
                  ...
                  children: [
                    IconButton(
                      icon: const Icon(Icons.edit, color: Colors.blue),
                      onPressed: () => context.push('/restaurateur/menus/${menu.id}/edit'),
                      tooltip: 'Modifier',
                    ),
                    IconButton(
                      icon: const Text('🗑️', style: TextStyle(fontSize: 20)),
