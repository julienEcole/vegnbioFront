...
class ReportOffreModal extends ConsumerStatefulWidget {
  final int offreId;
  final int? restaurantId;

  const ReportOffreModal({super.key, required this.offreId, this.restaurantId});

  @override
  ConsumerState<ReportOffreModal> createState() => _ReportOffreModalState();
}

class _ReportOffreModalState extends ConsumerState<ReportOffreModal> {
  ...
  Future<void> _submit() async {
    ...
    final req = ReportRequest(
      targetType: ReportTarget.offre,
      targetId: widget.offreId,
